...
export default function Edit({ auth, user }) {
    ...
    const validatePassword = (password) => {
        if (!password) return { isValid: true }; // Pas de validation si pas de mot de passe
    ...
    const submit = (e) => {
        ...
        put(route('admin.users.update', user.id), {
            onSuccess: () => {
                instantToast.success(t('userUpdatedSuccess', { name: data.name }));
            },
            onError: (errors) => {
                instantToast.error(t('errorUpdating'));
            }
        });
    };
    ...
    return (
        ...
        >
            <Head title={`${t('editUser')} - ${user.name}`} />
