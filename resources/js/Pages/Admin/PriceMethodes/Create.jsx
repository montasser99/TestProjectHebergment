...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        ...
        post(route('admin.price-methodes.store'), {
            onSuccess: () => {
                instantToast.success(t('paymentMethodCreatedSuccess', { name: data.methode_name }));
            },
            onError: (errors) => {
                instantToast.error(t('errorCreatingPaymentMethod'));
            }
        });
    };
