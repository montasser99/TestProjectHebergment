                                    ...
                                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                                        <div className="p-6">
                                            ...
                                            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                <h4 className="font-medium text-gray-900 dark:text-white mb-2">{t('contactInformation')}</h4>
                                                <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                                    {data.client_facebook && (
                                                        <p><strong>Facebook:</strong> {data.client_facebook}</p>
                                                    )}
                                                    {data.client_instagram && (
                                                        <p><strong>Instagram:</strong> {data.client_instagram}</p>
                                                    )}
                                                    {data.notes_client && (
                                                        <p><strong>Notes:</strong> {data.notes_client}</p>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                <h4 className="font-medium text-gray-900 dark:text-white">{t('orderedProducts')}</h4>
                                                {cart.map((item) => (
