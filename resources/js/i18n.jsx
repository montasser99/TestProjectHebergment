...
const resources = {
 ...
 // Méthodes de prix
            ...
            // Messages pour prix manquants par méthode de paiement
            noPriceForProductInPaymentMethod: 'Il n\'y a pas de prix pour ce produit dans la méthode de paiement {{method}}.',

            // Welcome page - Français
            welcome: 'Bienvenue',
            welcomeSubtitle: 'Découvrez notre collection exceptionnelle de produits authentiques et de qualité supérieure',
            startShopping: 'Commencer à acheter',
            login: 'Se connecter',
            register: 'S\'inscrire',
            goToDashboard: 'Aller au tableau de bord',
            whyChooseUs: 'Pourquoi nous choisir ?',
            whyChooseUsDesc: 'Nous nous engageons à vous offrir la meilleure expérience d\'achat en ligne',
            qualityProducts: 'Produits de qualité',
            qualityProductsDesc: 'Des produits authentiques sélectionnés avec soin pour leur qualité exceptionnelle',
            directContact: 'Contact direct',
            directContactDesc: 'Communication directe avec notre équipe pour un service personnalisé et des conseils sur mesure',
            personalizedService: 'Service personnalisé',
            personalizedServiceDesc: 'Chaque commande est traitée individuellement avec un suivi personnalisé de A à Z',
            ...
            readyToStartDesc: 'Rejoignez des milliers de clients satisfaits et découvrez nos produits uniques',
            ...
            phoneHelp: '8 chiffres obligatoires après +216',
            confirmYourPassword: 'Confirmez votre mot de passe',
            creatingAccount: 'Création du compte...',
            alreadyHaveAccount: 'Déjà un compte ?',
            
            // Contact section - Français
            contactUs: 'Contactez-nous',
            contactUsDesc: 'Pour plus d\'informations ou pour toute question, n\'hésitez pas à nous contacter',
            phoneWhatsApp: 'Téléphone / WhatsApp',
            
            // Payment Process section - Français
            paymentProcess: 'Notre processus de commande',
            paymentProcessDesc: 'Un processus simple et personnalisé pour votre confort',
            step1Title: 'Sélectionnez',
            step1Desc: 'Choisissez votre méthode de paiement préférée, sélectionnez vos produits puis validez votre commande',
            step2Title: 'Contact personnalisé',
            step2Desc: 'Notre équipe vous contacte directement pour confirmer votre commande',
            step3Title: 'Paiement flexible',
            step3Desc: 'Réglez selon la méthode convenue lors de notre échange',
            step4Title: 'Confirmation',
            step4Desc: 'Votre commande est confirmée et préparée avec soin',
            availablePaymentMethods: 'Méthodes de paiement disponibles',
            ooredooCard: 'Carte Ooredoo',
            d17Card: 'Carte D17',
            posteTunisieCard: 'Poste Tunisie',
            otherMethods: 'Autres méthodes',
            
            // Section méthode de paiement sélectionnée - Welcome
            selectedPaymentMethod: 'Méthode de paiement sélectionnée',
            youHaveChosen: 'Vous avez choisi',
            notSpecified: 'Non spécifiée',
            catalogAvailableWithPrices: 'Vous pouvez maintenant consulter notre catalogue avec les prix correspondants à votre méthode de paiement.',
            viewCatalog: 'Voir le catalogue',
            
            // Messages pour les profils read-only
            profileReadOnlyDescription: 'Vos informations de profil sont en lecture seule.',
            passwordReadOnlyDescription: 'Vos informations de mot de passe sont en lecture seule.',
            saved: 'Sauvegardé',
            
            // Dashboard - Admin et Gestionnaire
            adminDashboard: 'Tableau de Bord Administrateur',
            orderManagerDashboard: 'Gestionnaire de Commandes',
            completeAdministration: 'Administration Complète',
            completeOverview: 'Vue d\'ensemble complète de votre boutique AMAZIGHI SHOP',
            manageTrackOrders: 'Gérez et suivez les commandes de la boutique',
            userStatistics: 'Statistiques des Utilisateurs',
            totalUsers: 'Total Utilisateurs',
            allUsers: 'Tous les utilisateurs',
            activeUsers: 'Utilisateurs Actifs',
            nonBlockedUsers: 'Utilisateurs non bloqués',
            blockedUsers: 'Utilisateurs Bloqués',
            catalogAndProducts: 'Catalogue et Produits',
            productTypes: 'Types de Produits',
            availableCategories: 'Catégories disponibles',
            paymentMethodsAvailable: 'Options de paiement',
            totalProducts: 'Total Produits',
            totalProductsInCatalog: 'Produits en catalogue',
            productTypesAndNumbers: 'Types de Produits & Nombres',
            paymentMethodsAndProducts: 'Méthodes de Paiement & Produits',
            orderStatistics: 'Statistiques des Commandes',
            allOrders: 'Toutes les commandes',
            toProcess: 'À traiter',
            confirmed: 'Confirmées',
            cancelled: 'Annulées',
            productPricesHighToLow: 'Prix des Produits (Plus Haut au Plus Bas)',
            ordersByUser: 'Commandes par Utilisateur',
            noDataAvailable: 'Aucune donnée disponible',
            products: 'produits',
            commandsText: 'commandes',
    ...
    ar: {
        translation: {
            ...
            // رسائل للأسعار المفقودة حسب طريقة الدفع
            noPriceForProductInPaymentMethod: 'لا يوجد سعر لهذا المنتج في طريقة الدفع {{method}}.',

            // Welcome page - العربية
            welcome: 'مرحباً',
            welcomeSubtitle: 'اكتشف مجموعتنا الاستثنائية من المنتجات الأصيلة والعالية الجودة',
            startShopping: 'ابدأ التسوق',
            login: 'تسجيل الدخول',
            register: 'إنشاء حساب',
            goToDashboard: 'الذهاب إلى لوحة القيادة',
            whyChooseUs: 'لماذا تختارنا؟',
            whyChooseUsDesc: 'نحن ملتزمون بتقديم أفضل تجربة تسوق عبر الإنترنت لك',
            qualityProducts: 'منتجات عالية الجودة',
            qualityProductsDesc: 'منتجات أصيلة مختارة بعناية لجودتها الاستثنائية',
            directContact: 'تواصل مباشر',
            directContactDesc: 'تواصل مباشر مع فريقنا لخدمة شخصية ونصائح مخصصة',
            personalizedService: 'خدمة شخصية',
            personalizedServiceDesc: 'كل طلب يتم معالجته بشكل فردي مع متابعة شخصية من البداية إلى النهاية',
            ...
            readyToStartDesc: 'انضم إلى آلاف العملاء الراضين واكتشف منتجاتنا الفريدة',
            ...
            enterName: 'أدخل اسمك',
            phoneHelp: '8 أرقام مطلوبة بعد +216',
            confirmYourPassword: 'أكد كلمة المرور',
            creatingAccount: 'جاري إنشاء الحساب...',
            alreadyHaveAccount: 'لديك حساب بالفعل؟',
            
            // Contact section - العربية
            contactUs: 'اتصل بنا',
            contactUsDesc: 'للمزيد من المعلومات أو أي استفسار، لا تتردد في التواصل معنا',
            phoneWhatsApp: 'هاتف / واتساب',
            
            // Payment Process section - العربية
            paymentProcess: 'عملية الطلب لدينا',
            paymentProcessDesc: 'عملية بسيطة ومخصصة لراحتك',
            step1Title: 'اختر',
            step1Desc: 'اختر طريقة الدفع المفضلة، حدد منتجاتك ثم اعتمد طلبك',
            step2Title: 'تواصل شخصي',
            step2Desc: 'فريقنا يتصل بك مباشرة لتأكيد طلبك',
            step3Title: 'دفع مرن',
            step3Desc: 'ادفع وفقاً للطريقة المتفق عليها أثناء تواصلنا',
            step4Title: 'تأكيد',
            step4Desc: 'طلبك مؤكد ومحضر بعناية',
            availablePaymentMethods: 'طرق الدفع المتاحة',
            ooredooCard: 'كرت اوريدو',
            d17Card: 'كرت D17',
            posteTunisieCard: 'بريد تونس',
            otherMethods: 'طرق أخرى',
            
            // Section méthode de paiement sélectionnée - Welcome
            selectedPaymentMethod: 'طريقة الدفع المختارة',
            youHaveChosen: 'لقد اخترت',
            notSpecified: 'غير محدد',
            catalogAvailableWithPrices: 'يمكنك الآن تصفح كتالوجنا مع الأسعار المقابلة لطريقة الدفع الخاصة بك.',
            viewCatalog: 'عرض الكتالوج',
            
            // Messages pour les profils read-only
            profileReadOnlyDescription: 'معلومات ملفك الشخصي للقراءة فقط.',
            passwordReadOnlyDescription: 'معلومات كلمة المرور الخاصة بك للقراءة فقط.',
            saved: 'محفوظ',
            
            // Dashboard - Admin et Gestionnaire
            adminDashboard: 'لوحة قيادة المدير',
            orderManagerDashboard: 'مدير الطلبات',
            completeAdministration: 'إدارة كاملة',
            completeOverview: 'نظرة عامة كاملة على متجر AMAZIGHI SHOP',
            manageTrackOrders: 'إدارة وتتبع طلبات المتجر',
            userStatistics: 'إحصائيات المستخدمين',
            totalUsers: 'إجمالي المستخدمين',
            allUsers: 'جميع المستخدمين',
            activeUsers: 'المستخدمون النشطون',
            nonBlockedUsers: 'المستخدمون غير المحظورون',
            blockedUsers: 'المستخدمون المحظورون',
            catalogAndProducts: 'الكتالوج والمنتجات',
            productTypes: 'أنواع المنتجات',
            availableCategories: 'الفئات المتاحة',
            paymentMethodsAvailable: 'خيارات الدفع',
            totalProducts: 'إجمالي المنتجات',
            totalProductsInCatalog: 'المنتجات في الكتالوج',
            productTypesAndNumbers: 'أنواع المنتجات والأرقام',
            paymentMethodsAndProducts: 'طرق الدفع والمنتجات',
            orderStatistics: 'إحصائيات الطلبات',
            allOrders: 'جميع الطلبات',
            toProcess: 'للمعالجة',
            confirmed: 'مؤكدة',
            cancelled: 'ملغاة',
            productPricesHighToLow: 'أسعار المنتجات (من الأعلى إلى الأدنى)',
            ordersByUser: 'الطلبات حسب المستخدم',
    ...
    en: {
        translation: {
            ...
            // Messages for missing prices per payment method
            noPriceForProductInPaymentMethod: 'There is no price for this product in the {{method}} payment method.',

            // Welcome page - English
            welcome: 'Welcome',
            welcomeSubtitle: 'Discover our exceptional collection of authentic and high-quality products',
            startShopping: 'Start Shopping',
            login: 'Sign In',
            register: 'Sign Up',
            goToDashboard: 'Go to Dashboard',
            whyChooseUs: 'Why Choose Us?',
            whyChooseUsDesc: 'We are committed to providing you with the best online shopping experience',
            qualityProducts: 'Quality Products',
            qualityProductsDesc: 'Authentic products carefully selected for their exceptional quality',
            directContact: 'Direct Contact',
            directContactDesc: 'Direct communication with our team for personalized service and tailored advice',
            personalizedService: 'Personalized Service',
            personalizedServiceDesc: 'Each order is handled individually with personalized follow-up from A to Z',
            ...
            readyToStartDesc: 'Join thousands of satisfied customers and discover our unique products',
            ...
            phoneHelp: '8 digits required after +216',
            ...
            contactUsDesc: 'For more information or any questions, feel free to contact us',
            phoneWhatsApp: 'Phone / WhatsApp',
            
            // Payment Process section - English
            paymentProcess: 'Our Order Process',
            paymentProcessDesc: 'A simple and personalized process for your comfort',
            step1Title: 'Select',
            step1Desc: 'Choose your preferred payment method, select your products then validate your order',
            step2Title: 'Personal Contact',
            step2Desc: 'Our team contacts you directly to confirm your order',
            step3Title: 'Flexible Payment',
            step3Desc: 'Pay according to the agreed method during our exchange',
            step4Title: 'Confirmation',
            step4Desc: 'Your order is confirmed and carefully prepared',
            availablePaymentMethods: 'Available Payment Methods',
            ooredooCard: 'Ooredoo Card',
            d17Card: 'D17 Card',
            posteTunisieCard: 'Poste Tunisie',
            ...
            catalogAvailableWithPrices: 'You can now browse our catalog with prices corresponding to your payment method.',
            viewCatalog: 'View Catalog',
            
            // Messages pour les profils read-only
            profileReadOnlyDescription: 'Your profile information is read-only.',
            passwordReadOnlyDescription: 'Your password information is read-only.',
            saved: 'Saved',
            
            // Dashboard - Admin et Gestionnaire
            adminDashboard: 'Administrator Dashboard',
            orderManagerDashboard: 'Order Manager',
            completeAdministration: 'Complete Administration',
            completeOverview: 'Complete overview of your AMAZIGHI SHOP store',
            manageTrackOrders: 'Manage and track store orders',
            userStatistics: 'User Statistics',
            totalUsers: 'Total Users',
            allUsers: 'All users',
            activeUsers: 'Active Users',
            nonBlockedUsers: 'Non-blocked users',
            blockedUsers: 'Blocked Users',
            catalogAndProducts: 'Catalog and Products',
            productTypes: 'Product Types',
            availableCategories: 'Available categories',
            paymentMethodsAvailable: 'Payment options',
            totalProducts: 'Total Products',
            totalProductsInCatalog: 'Products in catalog',
            productTypesAndNumbers: 'Product Types & Numbers',
            paymentMethodsAndProducts: 'Payment Methods & Products',
            orderStatistics: 'Order Statistics',
            allOrders: 'All orders',
            toProcess: 'To process',
            confirmed: 'Confirmed',
            cancelled: 'Cancelled',
            productPricesHighToLow: 'Product Prices (Highest to Lowest)',
